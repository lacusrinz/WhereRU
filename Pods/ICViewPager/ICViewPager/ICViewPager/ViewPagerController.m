...
//
//  Change display style by RInz on 01/10/2014
...
- (void)setActiveTabIndex:(NSUInteger)activeTabIndex {
    ...
    UILabel* tab = (UILabel *)[tabView viewWithTag:101];
    tab.textColor = [UIColor blackColor];
    CGRect frame = tabView.frame;
    
    if (_activeContentIndex == 0) {
        UIView *tabViewPre = [self tabViewAtIndex:self.activeTabIndex-1];
        UILabel* tab = (UILabel *)[tabViewPre viewWithTag:101];
        tab.textColor = [UIColor grayColor];
    }else if (_activeContentIndex == self.tabCount-1){
        UIView *tabViewNext = [self tabViewAtIndex:self.activeTabIndex+1];
        UILabel* tab = (UILabel *)[tabViewNext viewWithTag:101];
        tab.textColor = [UIColor grayColor];
    }else{
        UIView *tabViewPre = [self tabViewAtIndex:self.activeTabIndex-1];
        UILabel* tabPre = (UILabel *)[tabViewPre viewWithTag:101];
        tabPre.textColor = [UIColor grayColor];
        UIView *tabViewNext = [self tabViewAtIndex:self.activeTabIndex+1];
        UILabel* tabNext = (UILabel *)[tabViewNext viewWithTag:101];
        tabNext.textColor = [UIColor grayColor];
    }
