...
// JASwipeCell
#define COCOAPODS_POD_AVAILABLE_JASwipeCell
#define COCOAPODS_VERSION_MAJOR_JASwipeCell 1
#define COCOAPODS_VERSION_MINOR_JASwipeCell 0
#define COCOAPODS_VERSION_PATCH_JASwipeCell 0
